...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BalacningPortInfo) DeepCopyInto(out *BalacningPortInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BalacningPortInfo.
func (in *BalacningPortInfo) DeepCopy() *BalacningPortInfo {
	if in == nil {
		return nil
	}
	out := new(BalacningPortInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceEndpoint) DeepCopyInto(out *ServiceEndpoint) {
	*out = *in
	...
	if in.ToPorts != nil {
		in, out := &in.ToPorts, &out.ToPorts
		*out = make([]BalacningPortInfo, len(*in))
		copy(*out, *in)
	}
}
